package com.nicnicdev.motivation.Data
...
class Mock {
    ...
    private val mListPhrase = listOf<Phrase>(
        ...
        Phrase("Insanidade é fazer sempre a mesma coisa e esperar resultados diferentes.", happy),
        Phrase("Não pare quando estiver cansado, pare quando tiver terminado", happy),
        Phrase("O que você pode fazer agora que tem maior impacto sobre o seu sucesso ?", happy),
        Phrase("A melhor maneira de prever o futuro é inventá-lo", sunny),
        Phrase("Você perde todas as chances que não aproveita.", sunny),
        Phrase("Fracasso é o condimento que dá sabor ao sucesso.", sunny),
        Phrase("Enquanto não estiversmos comprometidos, haverá hesitação.", sunny),
